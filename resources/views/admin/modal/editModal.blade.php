                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="type" name="type">
                                ...
                                <option value="kemasan" {{ $data->type === 'kemasan' ? 'selected' : '' }}>Kemasan</option>
                                <option value="per-dus" {{ $data->type === 'per-dus' ? 'selected' : '' }}>Per-Dus</option>
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="kategori" name="kategori">
                                ...
                                <option value="Minuman" {{ $data->kategory === 'Minuman' ? 'selected' : '' }}>Minuman
                                </option>
                            </select>
                        </div>
                    </div>
